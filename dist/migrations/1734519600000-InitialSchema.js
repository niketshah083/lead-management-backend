...
exports.InitialSchema1734519600000 = void 0;
class InitialSchema1734519600000 {
    ...
    async down(queryRunner) {
        await queryRunner.query(`ALTER TABLE \`notification_logs\` DROP FOREIGN KEY \`FK_notification_logs_user\``);
        await queryRunner.query(`ALTER TABLE \`notification_logs\` DROP FOREIGN KEY \`FK_notification_logs_config\``);
        await queryRunner.query(`ALTER TABLE \`sla_tracking\` DROP FOREIGN KEY \`FK_sla_tracking_policy\``);
        await queryRunner.query(`ALTER TABLE \`sla_tracking\` DROP FOREIGN KEY \`FK_sla_tracking_lead\``);
        await queryRunner.query(`ALTER TABLE \`lead_history\` DROP FOREIGN KEY \`FK_lead_history_changed_by\``);
        await queryRunner.query(`ALTER TABLE \`lead_history\` DROP FOREIGN KEY \`FK_lead_history_lead\``);
        await queryRunner.query(`ALTER TABLE \`messages\` DROP FOREIGN KEY \`FK_messages_sent_by\``);
        await queryRunner.query(`ALTER TABLE \`messages\` DROP FOREIGN KEY \`FK_messages_lead\``);
        await queryRunner.query(`ALTER TABLE \`leads\` DROP FOREIGN KEY \`FK_leads_assigned_to\``);
        await queryRunner.query(`ALTER TABLE \`leads\` DROP FOREIGN KEY \`FK_leads_category\``);
        await queryRunner.query(`ALTER TABLE \`user_categories\` DROP FOREIGN KEY \`FK_user_categories_category\``);
        await queryRunner.query(`ALTER TABLE \`user_categories\` DROP FOREIGN KEY \`FK_user_categories_user\``);
        await queryRunner.query(`ALTER TABLE \`auto_reply_templates\` DROP FOREIGN KEY \`FK_auto_reply_templates_category\``);
        await queryRunner.query(`ALTER TABLE \`category_media\` DROP FOREIGN KEY \`FK_category_media_category\``);
        await queryRunner.query(`ALTER TABLE \`users\` DROP FOREIGN KEY \`FK_users_manager\``);
...
exports.InitialSchema1734519600000 = InitialSchema1734519600000;
//# sourceMappingURL=1734519600000-InitialSchema.js.map
...
exports.LeadStatusModule = LeadStatusModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([entities_1.LeadStatusMaster, entities_1.StatusTransition])],
        controllers: [lead_status_controller_1.LeadStatusController],
        providers: [lead_status_service_1.LeadStatusService],
        exports: [lead_status_service_1.LeadStatusService],
    })
], LeadStatusModule);
